...
//Program to print output into a pdf directly with filename as Current Date 
import java.io.File;
...
public class PdfBox {
	...
	public static String generatePDFFileName(){				// to generate pdf file Name which consists of Date
...
//	public static char atoz() {					//to print a to z
//		char a='a';
//		while(a<='z') {
