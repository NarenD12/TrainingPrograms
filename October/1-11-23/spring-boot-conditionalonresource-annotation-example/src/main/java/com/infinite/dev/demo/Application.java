...
public class Application {
	...
	public static void main(String[] args) {
		...
		boolean containsEmailNotification = Arrays.stream(beans).anyMatch("emailNotification"::equalsIgnoreCase);
		boolean containsSMSNotification = Arrays.stream(beans).anyMatch("smsNotification"::equalsIgnoreCase);
		boolean containsTwitterNotification = Arrays.stream(beans).anyMatch("twitterNotification"::equalsIgnoreCase);
