                    ...
                    <div class="lg:w-1/2 lg:mx-6">
                        ...
                        <div class="mt-6 space-y-8 md:mt-8">
                            ...
                            <p class="flex items-start -mx-2">
                                ...
                                <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">(+91)9876543210</span>
                            </p>
                            ...
                            <p class="flex items-start -mx-2">
                                ...
                                <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">naren@gmail.com</span>
                            </p>
                        </div>
                        ...
                        <div class="mt-6 w-80 md:mt-8">
                            ...
                            <div class="flex mt-4 -mx-1.5 ">
                                ...
                                <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="https://www.linkedin.com/company/infinite-computer-solutions">
                        ...
                        <div
                            ...
                            <form class="mt-6">
                                <div class="flex-1">
                                    ...
                                    <input type="text" placeholder="Naren" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>

                                <div class="flex-1 mt-6">
                                    <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Email address</label>
                                    <input type="email" placeholder="naren@example.com" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
